				...
				<div class="container mt-5">
					...
					<form action="updateFilm.do" method="POST">
						...
						<div class="row">
							...
							<div class="col-3">
								<label for="title" title="${film.id}">Title:</label>
						...
						<div class="row">
							...
							<div class="col">
								...
								<input type="text" class="form-control" id="rentalRate"
									...
									value="<c:out value= '${film.rentalRate}' />" minlength="1"
						...
						<div class="row">
							...
							<div class="col">
								<input type="number" class="form-control" id="length"
									name="length" value="<c:out value='${film.length}' />"
						...
						<div class="row">
							...
							<div class="col">
								...
								<input type="text" class="form-control" id="replacementCost"
									...
									value="<c:out value='${film.replacementCost}'/>" minlength="1"
									maxlength="5" required>
							</div>
						...
						<div class="row">
							...
							<div class="col">
								...
								<input type="text" class="form-control" id="specialFeatures"
									...
									value="<c:out value='${film.specialFeatures}' />" minlength="0"
									maxlength="255">
							</div>
